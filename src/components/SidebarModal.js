...
function SidebarModal({pageType}) {
    const navigate = useNavigate();
    const { t } = useTranslation();

    return (
        <div className="bg-[#070707] text-[#FDFDFD] h-[100vh] w-[270px] pt-[30px] px-[20px] text-[22px] fixed left-0 z-1" onClick={(e) => e.stopPropagation()}>
